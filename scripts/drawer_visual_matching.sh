...
for urdf_version in "${urdf_version_arr[@]}"; do
  ...
  EXTRA_ARGS="--enable-raytracing True --additional-env-build-kwargs station_name=mk_station_recolor light_mode=simple disable_bad_material=True urdf_version=${urdf_version}"
