...
def calc_long_horizon_apple_in_drawer_stats(root_result_dir):
    ...
    drawer_task_map_dict = {
        "put_apple_into_top_drawer": [
            "PlaceIntoClosedTopDrawerCustomInScene-v0", # 甚至只统计top, 意味着别的都是白浪费时间渲染...
        ],
    }
    n_tasks = len(drawer_task_map_dict)
...
if __name__ == "__main__":
    print("Start calc metrics evaluation videos...")
    CKPT_MAPPING = {
        # "rt-2-x": "rt_2_x",
    ...
    print(df)
    print(f" Finish, save csv to {args.log_dir_root}/results.csv")
    exit(0)
