...
def get_args():
    ...
    parser.add_argument("--enable-raytracing", default=False)
    ...
    # parser.add_argument("--obj-episode-range", type=int, nargs=2, default=[0, 60], help="[start, end]") #是影响episode大小吗? 
    parser.add_argument("--obj-episode-range", type=int, nargs=2, default=[0, 2], help="[start, end]")
    parser.add_argument(
        "--obj-init-x-range",
        type=float,
        nargs=3,
    ...
    parser.add_argument("--ensembler", type=str, default="adapt", help="Ensembler type (default: adapt)") # 默认是adpat!!!
    parser.add_argument("--threshold", type=float, default=0.5, help="Threshold parameter for voteEnsembler (default: 0.5)")
